# Contributing to Chronon Energy Converter
...
```bash
git clone https://github.com/<your-username>/chronon-energy-converter.git
cd chronon-energy-converter
git remote add upstream https://github.com/GALACTIC-UNION/chronon-energy-converter.git
```
...
Use [GitHub Issues](https://github.com/GALACTIC-UNION/chronon-energy-converter/issues).
